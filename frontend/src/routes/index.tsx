	  ...
	  <div>
		...
		>
		  <h1 style={{ fontSize: 28, fontWeight: 800 }}>
			LIST OF RESTAURANTS · WHERE SHALL I EAT?
		  </h1>
		  <div style={{ maxWidth: 360, color: '#666' }}>
			Simple bookings with calendar... bulabula
		  </div>
		</div>
		...
		<div
		  style={{
			...
			gap: 16,
			justifyContent: 'center', // center tracks when there’s extra space
		  }}
		>
		  {samples.map((r) => (
			<div
				...
				<img
				  ...
				  onError={(e) => {
					(e.currentTarget as HTMLImageElement).src =
					  `https://picsum.photos/seed/${encodeURIComponent(r.slug)}/800/600`
				  }}
				  style={{
					width: '100%',
					height: '100%',
